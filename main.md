...
**チェックリスト**: [`format_checklist.md`](https://github.com/koki-yamada-lab/lab-writing-guideline/blob/main/docs/format_checklist.md) ← クリックするとリンクに飛びます
...
実際に書くときは，先ほどから参照しているの連載記事[伝わる論文を書くための心得 ～AI系トップ会議突破の執筆術～](https://note.com/taniai_phd/m/m2721f682739d)を読んでから書き進めると良いでしょう．これから書くセクションに対応するセクションの記事を熟読しておくとポイントが抑えられると思います．
...
基本的には当該箇所にコメントするにとどめ，直接文章を編集はしないです．これは，自分の力で添削をできるようにするための練習でもあるためです．締め切りが近くなると，教員が直接原稿を修正する場合もありますが，ゼミか1on1で修正内容について説明を入れます．
...
教員が書くレビューに`MUST:必須`，`ASK:質問`，`IMO:提案`のラベルがついている場合はGitHubで当該コメントに対して返信を書いてください．ラベルがついてないものには返信コメントは書かなくてもいよいです．
